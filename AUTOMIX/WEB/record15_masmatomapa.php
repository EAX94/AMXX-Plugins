...
<html>
	...
	<body>
		<?php
			...
			$topQuery = "SELECT DATE_FORMAT(`fecha`, '%d-%m-%Y') as fecha, GREATEST(w_pj_1_k,w_pj_2_k,w_pj_3_k,w_pj_4_k,w_pj_5_k, l_pj_1_k,l_pj_2_k,l_pj_3_k,l_pj_4_k,l_pj_5_k) as score,
