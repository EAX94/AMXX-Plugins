	...
	<body>
		<?php
			...
			echo "<tr align='center' bgcolor='#52697B'>
					...
					<th width='15%' align='center'>Da&ntilde;o</th>
					<th width='15%' align='center'>Mix jugado el</th>
				</tr>";
			
			$topQuery = "SELECT DATE_FORMAT(`fecha`, '%d-%m-%Y') as fecha, GREATEST(w_pj_1_dmg,w_pj_2_dmg,w_pj_3_dmg,w_pj_4_dmg,w_pj_5_dmg, l_pj_1_dmg,l_pj_2_dmg,l_pj_3_dmg,l_pj_4_dmg,l_pj_5_dmg) as score,
							CASE GREATEST(w_pj_1_dmg,w_pj_2_dmg,w_pj_3_dmg,w_pj_4_dmg,w_pj_5_dmg, l_pj_1_dmg,l_pj_2_dmg,l_pj_3_dmg,l_pj_4_dmg,l_pj_5_dmg)
								WHEN w_pj_1_dmg then w_pj_1
								WHEN w_pj_2_dmg then w_pj_2
								WHEN w_pj_3_dmg then w_pj_3
								WHEN w_pj_4_dmg then w_pj_4
								WHEN w_pj_5_dmg then w_pj_5
								WHEN l_pj_1_dmg then l_pj_1
								WHEN l_pj_2_dmg then l_pj_2
								WHEN l_pj_3_dmg then l_pj_3
								WHEN l_pj_4_dmg then l_pj_4
								WHEN l_pj_5_dmg then l_pj_5
							END as name
						FROM amix_partidos
						ORDER BY score DESC
						LIMIT 15;";
