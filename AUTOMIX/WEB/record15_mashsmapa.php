...
<html>
	...
	<body>
		<?php
			...
			$topQuery = "SELECT DATE_FORMAT(`fecha`, '%d-%m-%Y') as fecha, GREATEST(w_pj_1_hs,w_pj_2_hs,w_pj_3_hs,w_pj_4_hs,w_pj_5_hs, l_pj_1_hs,l_pj_2_hs,l_pj_3_hs,l_pj_4_hs,l_pj_5_hs) as score,
							CASE GREATEST(w_pj_1_hs,w_pj_2_hs,w_pj_3_hs,w_pj_4_hs,w_pj_5_hs, l_pj_1_hs,l_pj_2_hs,l_pj_3_hs,l_pj_4_hs,l_pj_5_hs)
								WHEN w_pj_1_hs then w_pj_1
								WHEN w_pj_2_hs then w_pj_2
								WHEN w_pj_3_hs then w_pj_3
								WHEN w_pj_4_hs then w_pj_4
								WHEN w_pj_5_hs then w_pj_5
								WHEN l_pj_1_hs then l_pj_1
								WHEN l_pj_2_hs then l_pj_2
								WHEN l_pj_3_hs then l_pj_3
								WHEN l_pj_4_hs then l_pj_4
								WHEN l_pj_5_hs then l_pj_5
							END as name
						FROM amix_partidos
						ORDER BY score DESC
						LIMIT 15;";
